...
import { insertMaintenanceLogSchema, type InsertMaintenanceLog, type Machine } from "@shared/schema";
...
export function AddMaintenanceModal({ open, onOpenChange, machines }: AddMaintenanceModalProps) {
  ...
  const onSubmit = async (data: InsertMaintenanceLog) => {
